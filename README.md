...
The project is in alpha, the current public version is a proof of concept test deemed "good enough" to release.
...
this is a good resource if you are having issues with a robot
